...
#   find what is wrong above




def student_count(arr, pages):
    students = 1
    pagesStudent = 0
...
print(student_count(arr, limit))  # Using your initial function
print(student_count1(arr, limit))  # Using your initial function
